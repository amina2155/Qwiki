...
const App = () => {
    ...
    const updateLevel = () => {
        console.log(route.params);
        console.log(level);
        console.log("userInfo.levelInPattern");
        console.log(userInfo.levelInPattern);
        // console.log(userInfo && userInfo.levelInNoMathRiddles == level && getTextScore() == numbers[level - 1])

        setModalVisible(true);
        if (userInfo && userInfo.levelInPattern == level && getTextScore() == numbers[level - 1] * 5) {
            const updatedUserInfo = { ...userInfo, levelInPattern: level + 1 };
